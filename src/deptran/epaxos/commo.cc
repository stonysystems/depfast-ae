...
void EPaxosCommo::SendDispatch(vector<TxPieceData>& cmd,
...
void EPaxosCommo::SendHandoutRo(SimpleCommand& cmd,
                               const function<void(int res,
                                                   SimpleCommand& cmd,
                                                   map<int,
                                                       mdb::version_t>& vers)>&) {
...
void EPaxosCommo::SendInquire(parid_t pid,
                             epoch_t epoch,
                             txnid_t tid,
...
void EPaxosCommo::BroadcastPreAccept(
    parid_t par_id,
    txnid_t txn_id,
    rank_t rank,
    ballot_t ballot,
...
EPaxosCommo::BroadcastPreAccept(
    parid_t par_id,
    txnid_t txn_id,
    rank_t rank,
    ballot_t ballot,
...
void EPaxosCommo::BroadcastAccept(parid_t par_id,
                                 txnid_t cmd_id,
                                 ballot_t ballot,
...
shared_ptr<QuorumEvent> EPaxosCommo::BroadcastAccept(parid_t par_id,
                                                    txnid_t cmd_id,
                                                    rank_t rank,
                                                    ballot_t ballot,
...
shared_ptr<QuorumEvent> EPaxosCommo::BroadcastValidation(CmdData& cmd_, int result) {
...
void EPaxosCommo::BroadcastCommit(
    parid_t par_id,
    txnid_t cmd_id,
    rank_t rank,
...
EPaxosCommo::BroadcastCommit(parid_t par_id,
                            txnid_t cmd_id,
                            rank_t rank,
                            bool need_validation,
                            parent_set_t& parents) {
